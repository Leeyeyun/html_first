...
## 바로가기링크란?
* 구분하기 위한 이름 `id`를 지정한 후 태그가 가진 아이디명을 href 속성에 작성하여 바로가기 링크로 활용할 수 있음
## 바로가기 링크 제작 순서 및 주의사항
1&#46; `id="..."` : 해당 태그의 이름 지정<br>
2&#46; `<a href="#..."></a>` : 태그이름을 바로가기태그에 넣기, &#35;은 아이디(href 속성에서만 사용 가능)
* href 속성 안이 비어있으면 안됨. 임시링크 &#35; 넣어놓기
## 파비콘이란?
* 탭 및 작업표시줄 등에 웹을 구분 가능하게 하는 아이콘
* 웹/앱 환경에 따라 정사각형 비율로 제작하여 사용
## 파비콘 적용 순서
* 파비콘 폴더 제작 후 폴더 안에 png 또는 ico 확장자 파일 넣기
* 파비콘.ico 경로에 상대경로 파일 올리는 코드 활용하여 이미지 삽입